void kesimpulanKondisiKeuangan(int persentaseKondisiKeuangan, char kondisiKeuangan[8]){
    if(persentaseKondisiKeuangan > 25 && strcmp(kondisiKeuangan, "Surplus") == 0){
        printf("Anda termasuk mahasiswa hemat dan produktif.");
    } else if (persentaseKondisiKeuangan > 0 && strcmp(kondisiKeuangan, "Surplus") == 0 ){
        printf("Keuangan Anda seimbang, tetap waspada terhadap pengeluaran tidak perlu.");
    } else if(persentaseKondisiKeuangan < 10 && strcmp(kondisiKeuangan, "Defisit") == 0 ){
